                        ...
                        <table id="data_list" class="table table-striped table-hover" cellspacing="0" width="100%">
                            ...
                            <s:iterator value="#request.pb.beanList" var="bookType">
                             <tbody>
	                                ...
	                                <td>
	                                	<button type="button" class="btn btn-link" data-toggle="modal" data-target="#updateModal" onclick="updateBookType(<s:property value="#bookType.typeId"/>)">修改</button>
	                                	<button type="button" class="btn btn-link" onclick="deleteBookType(<s:property value="#bookType.typeId"/>)">删除</button>
									...
									<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
										...
										<!---------------------表单-------------------->
												...
												<div class="modal-footer">
													...
													<button type="button" class="btn btn-default" id="addBookType">
														添加
													</button>
												</div>
											</div><!-- /.modal-content -->
									...
									<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
										...
										<!---------------------表单-------------------->
												...
												<div class="modal-footer">
													...
													<button type="button" class="btn btn-default" id="updateBookType">
														修改
													</button>
												</div>
											</div><!-- /.modal-content -->
