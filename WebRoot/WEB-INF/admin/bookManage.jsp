...
<body class="bootstrap-admin-with-small-navbar">
						...
						<div class="panel panel-default bootstrap-admin-no-table-panel">
							...
							<div
								...
								<form class="form-horizontal"
									action="${pageContext.request.contextPath}/admin/bookManageAction_queryBook.action"
									method="post">
									<div class="col-lg-12 form-group">
										<label class="col-lg-4 control-label" for="query_ano">
											<i class="glyphicon glyphicon-check"></i> 添加图书
										</label>
										<div class="col-lg-8 form-group">
											<button type="button" class="btn btn-default" id="btn_add"
												data-toggle="modal" data-target="#addModal">单本添加</button>
											<button type="button" class="btn btn-default"
												data-toggle="modal" data-target="#batchAddModal">批量添加</button>
											<button type="button" class="btn btn-default"
												onclick="exportBook()">全部导出</button>
										</div>
									</div>
									<div class="col-lg-12">
										<h3></h3>
										<label class="control-label" for="query_ano"> <i
											class="glyphicon glyphicon-check"></i> 图书查询
										</label>
									</div>
									...
									<div class="col-lg-5 form-group">
										<button type="submit" class="btn btn-default" id="btn_query"
									...
									<tbody>
										...
										<td>
											...
											<button type="button" class="btn btn-link"
												...
												id="btn_update"
												onclick="updateBook(<s:property value="#book.bookId"/>)">修改</button>
											<button type="button" class="btn btn-link"
												onclick="deleteBook(<s:property value="#book.bookId"/>)">删除</button>
											<button type="button" class="btn btn-link"
												onclick="addBookNum(<s:property value="#book.bookId"/>,<s:property value="#book.ISBN"/>)"
												data-toggle="modal" data-target="#addNumModal">新增</button>
										</td>
									</tbody>
								</s:iterator>
							</s:if>
						...
						<s:if test="#request.pb!=null">
							...
							<div class="pull-right">
								...
								<ul class="pagination">
									...
									<li><a
										href="${pageContext.request.contextPath}/admin/bookManageAction_${pb.url }pageCode=1">首页</a></li>
									<li><a
										href="${pageContext.request.contextPath}/admin/bookManageAction_${pb.url }pageCode=${pb.pageCode-1 }">&laquo;</a></li>
									<!-- 上一页 -->
									<%-- 循环显示页码列表 --%>
									<c:forEach begin="${begin }" end="${end }" var="i">
										<c:choose>
											...
											<c:otherwise>
												<li><a
													href="${pageContext.request.contextPath}/admin/bookManageAction_${pb.url }pageCode=${i}">${i}</a></li>
											</c:otherwise>
										</c:choose>
									</c:forEach>
									...
									<c:if test="${pb.pageCode < pb.totaPage }">
										<li><a
											href="${pageContext.request.contextPath}/admin/bookManageAction_${pb.url }pageCode=${pb.pageCode+1}">&raquo;</a></li>
									</c:if>
									<%--否则显示尾页 --%>
									<li><a
										href="${pageContext.request.contextPath}/admin/bookManageAction_${pb.url }pageCode=${pb.totaPage}">尾页</a></li>
								</ul>
							</div>
						</s:if>
					</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">批量添加新图书</h4>
					</div>
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-7" style="padding-top: 7px">
								<a
									href="${pageContext.request.contextPath}/admin/FileDownloadAction.action?fileName=book.xls">点击下载</a><br />
							</div>
						</div>
	...
	<form class="form-horizontal">
		<!--保证样式水平不混乱-->
		<!-- 模态框（Modal） -->
		<div class="modal fade" id="addNumModal" tabindex="-1" role="dialog"
			aria-labelledby="addNumModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true">&times;</button>
						<h4 class="modal-title" id="addNumModalLabel">新增图书数量</h4>
					</div>
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="hidden" id="addBookNumId"> <input
									type="text" class="form-control" id="addBookNumISBN"
									readonly="readonly"> <label class="control-label"
									for="addBookNumISBN" style="display: none;"></label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="addBookNum"
									placeholder="请输入新增的图书数量"> <label class="control-label"
									for="addBookNum" style="display: none;"></label>
							</div>
						</div>
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-default" id="add_BookNum">
							新增</button>
					</div>
				</div>
				<!-- /.modal-content -->
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="addISBN"
									placeholder="请输入国际标准书号"> <label class="control-label"
									for="addISBN" style="display: none;"></label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="addBookName"
									placeholder="请输入图书名称"> <label class="control-label"
									for="addBookName" style="display: none;"></label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="addAutho"
									placeholder="请输入作者名称"> <label class="control-label"
									for="addAutho" style="display: none;"></label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="addPress"
									placeholder="请输入出版社"> <label class="control-label"
									for="addPress" style="display: none;"></label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="addNum"
									placeholder="请输入图书总数量"> <label class="control-label"
									for="addNum" style="display: none;"></label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="addPrice"
									placeholder="请输入图书价格"> <label class="control-label"
									for="addPrice" style="display: none;"></label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								...
								<label class="control-label" for="addDescription"
									style="display: none;"></label>
							</div>
						</div>
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-default" id="addBook">
							添加</button>
					</div>
				</div>
				<!-- /.modal-content -->
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="firstname" class="col-sm-3 control-label">图书ISBN号</label>
							<div class="col-sm-7">
								<input type="hidden" id="updateBookId"> <input
									type="text" class="form-control" id="updateISBN"
									placeholder="请输入国际标准书号"> <label class="control-label"
									for="updateISBN" style="display: none;"></label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="updateAutho"
									placeholder="请输入作者名称"> <label class="control-label"
									for="updateAutho" style="display: none;"></label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="updatePress"
									placeholder="请输入出版社"> <label class="control-label"
									for="updatePress" style="display: none;"></label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="updatePrice"
									placeholder="请输入图书价格"> <label class="control-label"
									for="updatePrice" style="display: none;"></label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<textarea class="form-control" rows="3" id="updateDescription"
									placeholder="请输入图书简介"></textarea>
								<label class="control-label" for="updateDescription"
									style="display: none;"></label>
							</div>
						</div>
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-default" id="updateBook">
							修改</button>
					</div>
				</div>
				<!-- /.modal-content -->
