                            ...
                            <form class="form-horizontal">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 form-group">
                                        <button type="button" class="btn btn-default" id="btn_borrow">借书</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <table id="data_list" class="table table-striped table-hover" cellspacing="0" width="100%">
                            ...
                            <s:iterator value="#request.pb.beanList" var="borrow">
                             <tbody>
	                                ...
	                                <td>         
	                                	<button type="button" class="btn btn-link" data-toggle="modal" data-target="#findBorrowModal" onclick="getBorrowInfoById(<s:property value="#borrow.borrowId"/>)">查看</button>
